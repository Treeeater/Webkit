...
JSValue jsDocumentCookie(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    //zyc:
    String cookieACL = imp->getElementById("ACL")->getAttribute("cookieACL");
    String currentscripthash = currentWorld(exec)->scriptId()+";";
    if ((cookieACL!=NULL)&&(cookieACL!="")&&((!cookieACL.contains(currentscripthash))||(currentscripthash==";"))) return jsNull();
